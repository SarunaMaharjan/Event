...
public class SubFurniture extends AppCompatActivity {
    ImageView img;
    Button cart;
    ...
    DatabaseReference furniture;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sub_furniture);
    ...
    private void getDetailFurniture(String furnitureId)
    {

        furniture.child(furnitureId).addValueEventListener(new ValueEventListener() {
            @Override
