...
public class SubSound extends AppCompatActivity {
    ...
    DatabaseReference sound;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sub_sound);

        ActionBar actionBar = getSupportActionBar();
        actionBar.setTitle("Details");

        database = FirebaseDatabase.getInstance();
       sound = database.getReference("Sound");
    ...
    private void getDetailFood(String foodId)
    {
        ...
        sound.child(foodId).addValueEventListener(new ValueEventListener() {
            @Override
