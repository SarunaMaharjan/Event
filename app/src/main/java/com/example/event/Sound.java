            ...
            protected void populateView(View v, Object model, final int position)
            {
                ...
                img.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent subdecoration= new Intent(Sound.this,SubSound.class);
