...
public class SubProjector extends AppCompatActivity {
    ...
    DatabaseReference projector;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sub_projector);

        ActionBar actionBar = getSupportActionBar();
        actionBar.setTitle("Details");

        database = FirebaseDatabase.getInstance();
        projector = database.getReference("Projector");
    ...
    private void getDetailFood(String foodId)
    {
        ...
        projector.child(foodId).addValueEventListener(new ValueEventListener() {
            @Override
